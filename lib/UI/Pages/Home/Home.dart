...
import 'package:myntra/UI/Pages/other/category.dart';
        ...
        bottomNavigationBar: BottomNavigationBar(
          ...
          items: <BottomNavigationBarItem>[
            BottomNavigationBarItem(
              icon: Image.asset("assets/images/Myntra.png",height: 35,width: 35,),
              label: 'Home',
            ),
            BottomNavigationBarItem(
              icon:  Image.asset("assets/images/fwd.png",height: 35,width: 35,),
              label: 'Fwd',
            ),
            BottomNavigationBarItem(
              icon:  Image.asset("assets/images/li.png",height: 30,width: 30,),
              label: 'New',
            ),
            BottomNavigationBarItem(
              icon:  Image.asset("assets/images/tag.png",height: 35,width: 35,),
              label: 'Brands',
            ),
            BottomNavigationBarItem(
